export default {
  ...
  notifications: {
    changeCat: {
      title: 'Zmena obmedzení',
      text: {
        PL: 'Výstraha! V Poľsku došlo k zmenám v obmedzeniach. Ak sa chcete dozvedieť viac, prejdite na zvýraznenú kategóriu.',
        SK: 'Výstraha! Na Slovensku došlo k zmenám v obmedzeniach. Ak sa chcete dozvedieť viac, prejdite na zvýraznenú kategóriu.',
